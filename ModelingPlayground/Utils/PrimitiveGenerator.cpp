...
std::pair<std::vector<float>, std::vector<unsigned int>> PrimitiveGenerator::GenerateSphere(int latitudinalResolution,
...
std::pair<std::vector<float>, std::vector<unsigned int>> PrimitiveGenerator::GenerateCube()
{
    std::vector<float> vertices;
    std::vector<unsigned int> indices;
...
void PrimitiveGenerator::GenerateCubeFace(std::vector<float>& vertices, std::vector<unsigned int>& indices,
                                          glm::vec3 faceNormal)
{
    int indexA;
    int indexB;
